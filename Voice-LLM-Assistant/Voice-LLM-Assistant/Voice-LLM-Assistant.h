...
* @date          2021-06-04
*******************************************************************/
#ifndef VoiceLLMAssistant_H
#define VoiceLLMAssistant_H
...
class VoiceLLMAssistant : public QMainWindow
{
    Q_OBJECT

public:
    VoiceLLMAssistant(QWidget *parent = nullptr);
    ~VoiceLLMAssistant();
